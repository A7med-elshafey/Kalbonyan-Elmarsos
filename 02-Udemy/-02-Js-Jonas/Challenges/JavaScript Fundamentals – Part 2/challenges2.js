...
// function checkWinner(dolphinsScore, koalasScore) {
  //   if (dolphinsScore > koalasScore * 2) {
    ...
    //   if (koalasScore > dolphinsScore * 2) {
      ...
      //   }
      // }
      // const winner = console.log(checkWinner(46, 56));
...
console.log(mark.calcBMI(), johan.calcBMI());
if (mark.calcBMI() > johan.calcBMI()) {
  console.log(
    `Mark's BMI (${mark.calcBMI()}) is higher than John's (${johan.calcBMI()})`
    );
  } else {
    console.log(
      `John's BMI (${johan.calcBMI()}) is higher than Mark's (${mark.calcBMI()})`
      );
    }
